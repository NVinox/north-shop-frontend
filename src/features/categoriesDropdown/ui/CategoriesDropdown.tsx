...
export default function CategoriesDropdown() {
	...
	return (
		<div className="hidden md:block" onBlur={() => setOpen(false)}>
			<button
				className="lg:pr-[16px] text-sm p-[8px] pr-[8px] flex items-center gap-x-[16px] text-secondary-text rounded-card cursor-pointer transition-base bg-secondary hover:bg-secondary-hover"
			...
			<AnimatePresence>
				{isOpen && (
					<motion.nav
						...
						className="fixed top-[74px] left-0 bg-surface rounded-card py-[30px] w-full shadow-dropdown z-5"
					>
						<LayoutContainer>
